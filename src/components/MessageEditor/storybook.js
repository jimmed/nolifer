...
storiesOf('Component: Message Editor', module)
  ...
  .add('Initial State', () => <MessageEditor {...defaultProps} />)
  .add('Simple message', () => (
    <MessageEditor {...defaultProps} text="Hey there buddy" />
  ))
  .add('Overlong message', () => (
    <MessageEditor {...defaultProps} text={overlyLongString} />
  ))
  .add('Full test', () => <DemoMessageEditor onSend={action('send')} />);
